...
<body>
    ...
    <?php
    $customers = \App\Models\Social::where('type', 'Customers Service')->where('status', '1')->get();
    $inquiries = \App\Models\Social::where('type', 'Inquiries')->where('status', '1')->get();
    $accounts = \App\Models\Social::where('type', 'Accounts')->where('status', '1')->get();
    $recruitments = \App\Models\Social::where('type', 'Recruitment')->where('status', '1')->get();
    ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 make_right_ar">
                    ...
                    <a>
                        <p><i class="fas fa-phone-volume text-9 text-color-light mb-3 mt-2"></i>{{ trans('contactus_trans.customers_service') }}
                        </p>
                        <p class="mb-0" style="padding-left: 35px">
                            <span class="d-block text-2 p-relative bottom-3 Font_01 text-3 mt-2  Font_Clean">
