            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="at-inner-title-box">
                        <h2>{{ trans('homy_trans.available_property') }}</h2>
                        <p><a href="/home">{{ trans('front_trans.home') }}</a>
                            ...
                            @endif
                            <a href="{{ route('/home/available_property') }}">{{ trans('homy_trans.available_property') }}</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
    ...
    <section class="at-property-sec">
        <div class="container">
            <div class="row">
                ...
                <?php     $all_properties= \App\Models\Property::orderBy('id', 'desc')->where('status', 'for_sale')->paginate(9);  ?>
