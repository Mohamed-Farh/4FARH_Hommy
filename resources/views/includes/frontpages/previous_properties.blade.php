...
<head>
    <title>Previous Properties</title>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="at-inner-title-box">
                        <h2>{{ trans('homy_trans.previous_property') }}</h2>
                        <p><a href="/home">{{ trans('front_trans.home') }}</a>
                            ...
                            @endif
                            <a href="{{ route('/home/previous_property') }}">{{ trans('homy_trans.previous_property') }}</a>
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
    ...
    <section class="at-property-sec">
        <div class="container">
            <div class="row">
                ...
                <?php     $all_properties= \App\Models\Property::orderBy('id', 'desc')->where('status', 'sold')->paginate(9);  ?>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="at-property-item at-col-default-mar">
                            ...
                            <div class="at-property-location">
                                <h4><i class="fa fa-home" aria-hidden="true"></i><a href="properties-details.html">
                                    @if (App::getLocale() == 'en')
