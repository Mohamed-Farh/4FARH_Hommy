        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => ['agents.update', $agent->id], 'method' => 'patch', 'files'=>true ]) !!}
                    {{--------- About Us -----------}}
                    <div class="row beauty_top">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('name_ar', old('name_ar', $agent->name_ar ), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('name_en', old('name_en', $agent->name_en), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-6  beauty_top">
                            <div class="form-group">
                                ...
                                {!! Form::text('position_ar', old('position_ar', $agent->position_ar), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-6  beauty_top">
                            <div class="form-group">
                                ...
                                {!! Form::text('position_en', old('position_en', $agent->position_en), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('about_ar', old('about_ar', $agent->about_ar), ['class' => 'form-control summernote']) !!}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('about_en', old('about_en', $agent->about_en), ['class' => 'form-control summernote']) !!}
                            ...
                            @error('photo')<span class="text-danger">{{ $message }}</span>@enderror
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('phone', old('phone', $agent->phone), ['class' => 'form-control']) !!}
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('ex_years', old('ex_years', $agent->ex_years), ['class' => 'form-control']) !!}
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('email', old('email', $agent->email), ['class' => 'form-control']) !!}
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('facebook', old('facebook', $agent->facebook), ['class' => 'form-control']) !!}
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('twitter', old('twitter', $agent->twitter), ['class' => 'form-control']) !!}
                                ...
                                <div class="col-6  beauty_top">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('linked_in', old('linked_in', $agent->linked_in), ['class' => 'form-control']) !!}
