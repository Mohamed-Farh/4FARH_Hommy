    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                {{ trans('contactus_trans.add_contactus') }}
            </button>
            <br><br>
                        ...
                        <tbody>
                            ...
                            @if ($social->contact == '1')
                                <tr>
                                    ...
                                    <td>{{ trans('social_trans.'.$social->type) }}</td>
                                    <td>
                                        @if  ($social->status == '1')
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#vis{{ $social->id }}"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col">
                                                            ...
                                                            <select name="type" required class="form-control">
                                                                <option value="0"                   <?php if($social->type == "0")                  echo "selected"; ?> >       {{ trans('social_trans.0') }}                   </option>
                                                                <option value="What's App"          <?php if($social->type == "What's App") echo "selected"; ?> >       What's App   </option>
                                                                <option value="Customers Service"   <?php if($social->type == "Customers Service")  echo "selected"; ?> >       {{ trans('social_trans.Customers Service') }}   </option>
                                                                <option value="Inquiries"           <?php if($social->type == "Inquiries")          echo "selected"; ?> >       {{ trans('social_trans.Inquiries') }}           </option>
                                                                <option value="Accounts"            <?php if($social->type == "Accounts")           echo "selected"; ?> >       {{ trans('social_trans.Accounts') }}            </option>
                                                                <option value="Recruitment"         <?php if($social->type == "Recruitment")        echo "selected"; ?> >       {{ trans('social_trans.Recruitment') }}         </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                ...
                                <!-- Make_Image_Visible -->
                                <div class="modal fade" id="vis{{ $social->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                        ...
                        <div class="form-group">
                            <div class="col">
                                ...
                                <select name="type" required class="form-control">
                                    ...
                                    <option value="Customers Service"   >         {{ trans('social_trans.Customers Service') }}   </option>
                                    <option value="Inquiries"           >         {{ trans('social_trans.Inquiries') }}           </option>
                                    <option value="Accounts"            >         {{ trans('social_trans.Accounts') }}            </option>
                                    <option value="Recruitment"         >         {{ trans('social_trans.Recruitment') }}         </option>
                                </select>
                            </div>
                        </div>
