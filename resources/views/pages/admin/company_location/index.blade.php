                        ...
                        <?php $i = 0; ?>
                            ...
                            @foreach ($company_locations as $location)
                                <?php $i++; ?>
                                    ...
                                    <td><a href="{{ $location->map_url }}" target="_blank" style="color: blue">{{ trans('homy_trans.show_location') }}</a></td>
                                    ...
                                    <div class="modal-content"  style="width: 120% !important; ">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('company_location.update', 'test') }}" method="post">
                                                ...
                                                <div class="row"  style="padding: 25px 0px 5px 0px;">
                                                    <div class="col-12">
                                                        <label for="map_url" class="mr-sm-2">{{ trans('homy_trans.map_link') }}
                                                            :</label>
                                                        <input type="url" step="any" class="form-control" name="map_url" value="{{ $location->map_url }}">
                                                    </div>
                                                </div>

                                                <div class="row"  style="padding: 25px 0px 5px 0px;">
                                                    <div class="col-12">
                                                        <label for="map_frame" class="mr-sm-2">{{ trans('homy_trans.map_frame') }}
                                                            :</label>
                                                        <input type="url" step="any" name="map_frame" class="form-control" value="{{ $location->map_frame }}">
                                                    </div>
                                                </div>
                ...
                <form action="{{ route('company_location.store') }}" method="POST">
                    ...
                    <div class="row"  style="padding: 25px 0px 5px 0px;">
                        <div class="col-12">
                            <label for="map_url" class="mr-sm-2">{{ trans('homy_trans.map_link') }}
                                :</label>
                            <input type="url" step="any" class="form-control" name="map_url">
                        </div>
                    </div>
                    ...
                    <div class="row"  style="padding: 25px 0px 5px 0px;">
                        <div class="col-12">
                            <label for="map_frame" class="mr-sm-2">{{ trans('homy_trans.map_frame') }}
                                :</label>
                            <input type="url" step="any" name="map_frame" class="form-control">
                        </div>
                    </div>
