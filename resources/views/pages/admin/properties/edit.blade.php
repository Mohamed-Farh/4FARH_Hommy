            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                {!! Form::label('property_floors', trans('property_trans.no_of_floor') ) !!}
                                {!! Form::number('property_floors', old('property_floors', $property->no_of_floor ), ['class' => 'form-control']) !!}
                                @error('property_floors')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    ...
                    <div class="row  beauty1">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                {!! Form::label('country_ar', trans('property_trans.country_ar') ) !!} *
                                {!! Form::text('country_ar', old('country_ar', $property->country_ar ), ['class' => 'form-control']) !!}
                                @error('country_ar')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                {!! Form::label('country_en', trans('property_trans.country_en') ) !!} *
                                {!! Form::text('country_en', old('country_en', $property->country_en ), ['class' => 'form-control']) !!}
                                @error('country_en')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                    ...
                    <div class="row beauty1">
                        <div class="col">
                            <div class="form-group">
                                {!! Form::label('map_url', trans('property_trans.map_url') ) !!} *
                                {!! Form::text('map_url', old('map_url', $property->map_url ), ['class' => 'form-control']) !!}
                                @error('map_url')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                {!! Form::label('map_frame', trans('property_trans.map_frame') ) !!} *
                                {!! Form::text('map_frame', old('map_frame', $property->map_frame ), ['class' => 'form-control']) !!}
                                @error('map_frame')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
                    <div class="row beauty">
