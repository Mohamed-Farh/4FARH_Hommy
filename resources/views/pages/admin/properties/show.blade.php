                    ...
                    <table class="table table-striped" style="padding-top: 20px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>{{ $property->purpose == 'rent' ? trans('property_trans.rent') : trans('property_trans.sale') }}
                                </th>
                            </tr>
                            <tr>
                                <th scope="row"></th>
                            ...
                            <tr>
                                ...
                                <th>{{ $property->property_floors }}</th>
                            </tr>
                        </tbody>
                    </table>
                    <br>
                    <table class="table table-striped" style="padding-top: 20px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (App::getLocale() == 'en')
                                    @if ($property->city_en != '')
                                        <th>{{ $property->country_en }} -  {{ $property->city_en }}</th>
                                    @else
                                        <th>{{ $property->country_ar }} -  {{ $property->city_ar }}</th>
                                    @endif
                                @else
