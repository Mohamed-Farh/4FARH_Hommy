            ...
            <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="row beauty">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                {!! Form::number('property_floors', old('property_floors'), ['class' => 'form-control']) !!}
                        ...
                        <div class="col-6 small_space">
                            ...
                            @foreach ($features as $feature_id)
                                <div class="col-sm-3">
                                    @if (App::getLocale() == 'en')
                                        @if ($category_en !='')
                                            {!! Form::checkbox('feature_id[]', $feature_id->id ) !!}
                    ...
                    <div class="row beauty1">
                        <div class="col">
                            <div class="form-group">
                                ...
                                {!! Form::text('map_url', old('map_url'), ['class' => 'form-control']) !!}
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                {!! Form::text('map_frame', old('map_frame'), ['class' => 'form-control']) !!}
                    ...
                    <div class="row beauty">
                        <div class="col-12">
                            <div class="form-group">
                                {!! Form::label('nearby_ar', trans('property_trans.nearby_ar') ) !!} *
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                {!! Form::label('nearby_en', trans('property_trans.nearby_en') ) !!} *
                    ...
                    <div class="row pt-4">
                        <div class="col-12">
                            ...
                            <br>
                            <div>
                                {!! Form::file('images[]', ['class' => 'file-input-overview', 'multiple' => 'multiple']) !!}
                                @error('images')<span class="text-danger">{{ $message }}</span>@enderror
                            </div>
                        </div>
                    </div>
