                    ...
                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>{{ trans('homy_trans.country') }}</th>
                                <th>{{ trans('property_trans.city') }}</th>
                                <th>{{ trans('property_trans.address') }}</th>
                                <th>{{ trans('homy_trans.property_comments') }}</th>
                            ...
                            <tbody>
                                ...
                                @forelse ($properties as $property)
                                    <tr>
                                        ...
                                        @if (App::getLocale() == 'en')
                                            @if ($property->country_en !='')
                                                <td>{{ $property->country_en }}</td>
                                            @else
                                                <td>{{ $property->country_ar }}</td>
                                            @endif
                                        @else
                                            <td>{{ $property->country_ar }}</td>
                                        @endif
                                        ...
                                        <td><a href="/property/show_property_comments/{{ $property->id }}" target="_blank" style="color: blue">{{trans('homy_trans.show_comments')}}</a></td>
