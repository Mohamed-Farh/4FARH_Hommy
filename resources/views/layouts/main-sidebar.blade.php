                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#location-menu">
                            <div class="pull-left"><i class="fas fa-map-marker-alt"></i><span
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#time-menu">
                            <div class="pull-left"><i class="fas fa-stopwatch"></i><span
                     ...
                     <!-- subscribes-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#subscribes-menu">
                            <div class="pull-left"><i class="far fa-thumbs-up"></i><span
                                    class="right-nav-text">{{trans('admins_trans.subscribes')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="subscribes-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('subscribes.index')}}">{{trans('admins_trans.subscribes')}}</a></li>                        </ul>
                    </li>

                     <!-- agents-->
                     <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#agents-menu">
                            <div class="pull-left"><i class="fas fa-people-arrows"></i><span
                                    class="right-nav-text">{{trans('homy_trans.agents')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="agents-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('agents.index')}}">{{trans('homy_trans.agents_list')}}</a></li>                        </ul>
                    </li>
