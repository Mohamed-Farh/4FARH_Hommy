...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            $property->property_floors      = $request->property_floors;

            $property->country_ar           = $request->country_ar;
            $property->country_en           = $request->country_en;
            ...
            $property->map_frame            = $request->map_frame;
